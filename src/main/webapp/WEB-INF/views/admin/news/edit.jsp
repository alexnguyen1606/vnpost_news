    ...
    <div class="col-sm-12">
        ...
        <form:input path="id" type="hidden" ></form:input>
            ...
            <%--<form class="form-horizontal" role="form" id="formEdit">--%>
                <%--<input type="hidden" id="id" name="id" value="${newsItem.id}">--%>
                <%--<div class="form-group">--%>
                    <%--<label class="col-sm-3 control-label no-padding-right" for="name">Tên bài viết</label>--%>

                    <%--<div class="col-sm-9">--%>
                        <%--<input type="text" id="name" name="name" value="${newsItem.name}" placeholder="" class="col-xs-10 col-sm-5" />--%>
                    <%--</div>--%>
                <%--</div>--%>
                <%--<div class="form-group">--%>
                    <%--<label class="col-sm-3 control-label no-padding-right" for="title">Title </label>--%>
                    ...
                    <%--<div class="col-sm-9">--%>
                        <%--<input type="text" id="title" name="title" value="${newsItem.title}" placeholder="" class="col-xs-10 col-sm-5" />--%>
                    <%--</div>--%>
                <%--</div>--%>
                    <%--<div class="form-group">--%>
                    ...
                    <%--</div>--%>
                    <%--<div class="form-group">--%>
                        <%--<label class="col-sm-3 control-label no-padding-right" >Title Ảnh 1 </label>--%>

                        <%--<div class="col-sm-9">--%>
                            <%--<input type="text"  id="titleImage" name="titleImage" value="" placeholder="" class="col-xs-10 col-sm-5" />--%>
                        <%--</div>--%>
                    <%--</div>--%>
                    <%--<div class="form-group">--%>
                        <%--<label class="col-sm-3 control-label no-padding-right" for="title">Nội dung 1</label>--%>

                        <%--<div class="col-sm-9">--%>
                            <%--<textarea type="" id="content" name="content" value="" placeholder="" class="col-xs-10 col-sm-5" ></textarea>--%>
                        <%--</div>--%>
                    <%--</div>--%>
                ...
                <%--<div class="form-group">--%>
                    ...
                    <%--<div class="col-sm-9">--%>
                        <%--<select class="form-control" name="status" id="status">--%>
                                <%--<option value="1" ${newsItem.status == 1 ? "selected":""}>Enable</option>--%>
                            <%--<option value="0" ${newsItem.status == 0 ? "selected":""}>Disable</option>--%>
                        <%--</select>--%>
                    <%--</div>--%>
                <%--</div>--%>
                <%--<div class="form-group">--%>
                <%--<label class="col-sm-3 control-label no-padding-right">Chuyên mục</label>--%>
                <%--<div class="col-sm-9">--%>
                <%--<select name="category" id="category" cssClass="form-control">--%>
                <%--<c:forEach items="${category}" var="item">--%>
                ...
                <%--</div>--%>
                <%--<div class="form-group">--%>
                    <%--<label class="col-sm-3 control-label no-padding-right" for="author">Tác giả</label>--%>

                    <%--<div class="col-sm-9">--%>
                        <%--<input type="text" id="author" name="author" value="${newsItem.author}" placeholder="" class="col-xs-10 col-sm-5" />--%>
                    <%--</div>--%>
                <%--</div>--%>
                <%--<div class="form-group">--%>
                    <%--<div class="col-sm-5">--%>
                        <%--<button type="button" class="btn btn-sm btn-success " id="btnAddNews" style="left:450px;">--%>
                            <%--Submit--%>
